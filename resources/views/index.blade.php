                ...
                <a href="98"  class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-body">
                       <!--begin::Svg Icon | path: icons/duotune/general/gen049.svg-->
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">45</div>
                ...
                <a href="#" class="card bg-primary hoverable card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-body">
                       <!--begin::Svg Icon | path: icons/duotune/graphs/gra005.svg-->
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">12</div>
                        <div class="fw-bold text-gray-100">Total hotels</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Statistics Widget 5-->
