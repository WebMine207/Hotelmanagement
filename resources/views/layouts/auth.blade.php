...
<head>
    ...
    <meta charset="utf-8" />
    <link rel="shortcut icon"  href="{{ asset('img/favicon-lion.png') }}" />
    <!--begin::Fonts-->
					...
					<div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
						...
						<div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
							...
							<a href="Javascript:;" class="py-9 mb-5">
								<img alt="Logo" src="{{ asset('img/logoo-lioon.png') }}" class="h-50px h-lg-45px" />
                                
							</a>
							<!--end::Logo-->
							<!--begin::Title-->
							<h1 class="fw-bolder fs-2qx pb-5 pb-md-10" style="color: #ffff2f;">Welcome</h1>
							<!--end::Title-->
						</div>
						<!--end::Content-->
					</div>
